...
Give an algorithm for finding an ordered word pair (e.g. “New York”) occurring with the greatest frequency in a given webpage. Which data structures
...
First, we use Hash table to store pair of words, then use array to sort it.
